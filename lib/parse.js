...
function createParser(options) {
	...
	function arrayToObject(length, object) {
		if (length > 10) {
			if (length > 11) {
				if (length === 12) {
		...
		if (!object)
			object = property.constructs ? new property.constructs() : {} // TODO: we could probably construct a new reader that does this a little faster
		var value
