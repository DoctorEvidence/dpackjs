	...
	class Shared extends Array {
		...
		propertyUsed(property, object, serializer) {
			...
			if (lastObject === object) {
				...
				if (property.comesAfter.indexOf(lastProperty) === -1)
...
function copyProperty(source, target, freezeTarget, startingIndex) {
	...
	for (var i = startingIndex || 0, l = source.resetTo > -1 ? source.resetTo : source.length; i < l; i++) {
