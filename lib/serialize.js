...
function createSerializer(options) {
	...
	function writeAsDefault(value, parentProperty) {
		...
		if (constructor === Object) {
			...
			if (parentProperty === rootProperty) {
				startSequence()
				writeProperty(value, null, 'array').writeValue(value)
			...
			return writeProperty(value, null, 'array').writeValue(value)
		} else {
			if (object.then) {
	...
	function writeAsBlock(value) {
		...
		if (value && value.constructor === serialize.Block) {
