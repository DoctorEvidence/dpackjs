...
function createSerializer(options) {
	...
	function writeAsArray(array) {
		if (array && array.constructor === Array) { // check to make sure it is an array
			...
			var arrayProperty = property
			var elementsProperty = arrayProperty.elements || arrayProperty // set the current property to the elements property
	...
	function writePromise(promise) { // in object mode
		var id = nextBlockId--
		writeToken(NUMBER_CODE, getRelativeReference(id)) // should be in object mode
		var lazyPromise = {
