...
var binaryMapped = {
	get: function(target, key) {
		...
		// if it can't be found in the fixed table we have to resort parsing everything, but first we need to extend
		// our fixed table to include this property so that next time this doesn't happen
		fixedTable[key] = Object.keys(fixedTable).length * 4
